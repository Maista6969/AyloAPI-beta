...
def men(obj: Any, _) -> Any:
    ...
    studio_name = dig(fixed, "studio", "name")
    scene = "/sceneid/" if studio_name != "TwinkPop" else "/scene/"
    model = "/modelprofile/" if studio_name != "TwinkPop" else "/pornstar/"
    domain = "men.com" if studio_name != "TwinkPop" else "twinkpop.com"
